...
if __name__ == '__main__':
    ...
    propagation1 = FurrierPropagation(N, (length*scale, length), wavelength, 1.0, 0.0, focus*(scale + 1), border_ratio=1.0)
    print(propagation1.length.input.x, propagation1.length.input.y, propagation1.length.output.x, propagation1.length.output.y, propagation1.distance)
